...
همچنین فراموش نکنید که یک فایل به نام `.env.example` در پوشه `backend` بسازید و محتوای زیر را در آن قرار دهید (این فایل در گیت‌هاب قرار می‌گیرد تا بقیه بدانند چه متغیرهایی نیاز است، اما رمز شما لو نمی‌رود):
