    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white px-4 transition-colors duration-300 relative">
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 p-8 sm:p-10 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-2 text-center">ایمیل خود را وارد کنید تا لینک بازنشانی برای شما ارسال شود.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-14 pr-12 pl-4 bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl outline-none focus:border-indigo-500 focus:bg-white dark:focus:bg-gray-800 transition-all text-gray-900 dark:text-white"
              required
            />
          </div>
          <button
