  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white px-4 py-12 transition-colors duration-300">
      ...
      <div className="text-center mb-12 max-w-3xl">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-lg">از ابزارهای رایگان شروع کنید و هر زمان که کسب‌وکارتان رشد کرد، ارتقا دهید.</p>
      </div>
            ...
            <ul className="space-y-3">
              {plan.features.map((feature, j) => (
                <li key={j} className="flex items-start gap-2 text-sm">
                  ...
                  <span className={feature.included ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-600 line-through'}>{feature.text}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <p className="mt-12 text-center text-sm text-gray-500 dark:text-gray-400 max-w-2xl">تمام قیمت‌ها به تومان است. پرداخت‌ها از طریق درگاه امن بانکی زرین‌پال انجام می‌شود.</p>
    </main>
  );
}